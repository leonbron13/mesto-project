...
export const formEditElement = profilePopup.querySelector('.form');
...
export const formChangeElement = avatarPopup.querySelector('.form');
...
export const popupAddCard = document.querySelector('.popup__sample');
